...
let allNumber = document.body.children[5]
console.log(allNumber.children.length);
...
let firstChild = document.querySelector('.topics').children[0].innerText= `This is the first child element`
